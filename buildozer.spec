...
# (str) Package name
package.name = laboratory

# (str) Package domain (needed for android/ios packaging)
package.domain = laboratory.sytes.net
...
# Do not prefix with './'
source.exclude_patterns = LICENSE, store, requirements.txt, README.md, .gitignore
...
presplash.filename = %(source.dir)s/img/text.png
...
android.presplash_color = #81D8D0
